...
import { errorToast, successToast } from "../../../../components/Alert/Alert";
...
export default function Register() {
    ...
    const submitHandler = async (e) => {
        ...
        if(userName === "" || firstName === "" || lastName === "" || email === "" || password === ""){
            errorToast("Please ensure all fields are completed")
            return
        }

        try {
            const result = await axios.post("http://localhost:5000/api/users/register", {userName, firstName, lastName, email, password});

            console.log(result, "The Result from Database")
            successToast("Account Created Successfully. You will be redirected to verify your email address")
            setTimeout(() => {
                navigate("/auth")
            }, 3000)
                ...
                <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
                    ...
                    <div className="bg-white shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
                        ...
                        <div>
                            ...
                            id="firstName" aria-labelledby="firstName" type="text" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2"  />
                        </div>
                        ...
                        <div>
                            ...
                            value={form.lastName}
                            onChange={changeHandler}
                            id="lastName" aria-labelledby="lastName" type="lastName" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        ...
                        <div>
                            ...
                            value={form.email}
                            onChange={changeHandler}
                            id="email" aria-labelledby="email" type="email" className="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        ...
                        <div className="mt-6 w-full">
                            ...
                            <div className="relative flex items-center justify-center">
                                ...
                                value={form.password}
                                onChange={changeHandler}
                                 id="myInput" type={showpass ? "text" : "password"} className="bg-gray-200 border rounded text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        ...
                        <div className="mt-8">
                            <button onClick={submitHandler} className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                                Create Account
                            </button>
                        </div>
                    </div>
